...
class SimulationControl(NoExtraBaseModel):
    ...
    type: Literal['SimulationControl'] = 'SimulationControl'
...
class ShadowCalculation(NoExtraBaseModel):
    ...
    type: Literal['ShadowCalculation'] = 'ShadowCalculation'
...
class DaylightSavingTime(DatedBaseModel):
    ...
    type: Literal['DaylightSavingTime'] = 'DaylightSavingTime'
...
class RunPeriod(DatedBaseModel):
    ...
    type: Literal['RunPeriod'] = 'RunPeriod'
    ...
    holidays: Union[List[Annotated[List[int], Field(min_length=2, max_length=2)]], None] = Field(
        default=None,
    ...
    daylight_saving_time: Union[DaylightSavingTime, None] = Field(
        default=None,
    ...
    def check_dates(self) -> 'RunPeriod':
        """Check that all of the input dates are valid."""
        self.check_date(self.start_date, self.leap_year)
        self.check_date(self.end_date, self.leap_year)
        if self.holidays is not None:
            for hol in self.holidays:
                self.check_date(hol, self.leap_year)
        return self
...
class SizingParameter(NoExtraBaseModel):
    ...
    type: Literal['SizingParameter'] = 'SizingParameter'

    design_days: Union[List[DesignDay], None] = Field(
        default=None,
    ...
    efficiency_standard: Union[EfficiencyStandards, None] = Field(
        default=None,
    ...
    climate_zone: Union[ClimateZones, None] = Field(
        default=None,
    ...
    building_type: Union[str, None] = Field(
        default=None,
...
class SimulationParameter(NoExtraBaseModel):
    ...
    type: Literal['SimulationParameter'] = 'SimulationParameter'

    output: Union[SimulationOutput, None] = Field(
        default=None,
        description='A SimulationOutput that lists the desired outputs from the '
        'simulation and the format in which to report them.'
    )

    run_period: Union[RunPeriod, None] = Field(
        default=None,
